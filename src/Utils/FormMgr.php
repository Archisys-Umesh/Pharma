...
class FormMgr
{
    ...
    public static function formGroupTemplate($field)
    {
        ...
        if ($form->hasClass('form-horizontal')) {
            ...
            $html = Element::div(true)->addClass('col-sm-9')->toHtml($html);
        }
    ...
    public static function radioCheckboxTemplate($field)
    {
        ...
        //Horizontal form
        if ($form->hasClass('form-horizontal')) {
            $html = Element::div(true)->addClass('col-sm-offset-3 col-sm-10')->toHtml($html);
        }
    ...
    protected static function getRadioCheckHtml($field)
    {
        ...
        $html = $field->input->toHtml();
        $html = $html.$field->label->toHtml().$field->errorLabel;
