...
/**
 * Base class that represents a row from the 'survey_category' table.
 *
 *
 *
 * @package    propel.generator.entities.Base
 */
abstract class SurveyCategory implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\entities\\Map\\SurveyCategoryTableMap';
    ...
    /**
     * The value for the survey_cat_name field.
     *
     * @var        string|null
     */
    protected $survey_cat_name;
    ...
    /**
     * Initializes internal state of entities\Base\SurveyCategory object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>SurveyCategory</code> instance.  If
     * <code>obj</code> is an instance of <code>SurveyCategory</code>, delegates to
     * <code>equals(SurveyCategory)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [survey_cat_name] column value.
     *
     * @return string|null
     */
    public function getSurveyCatName()
    {
        return $this->survey_cat_name;
    }
    ...
    public function setSurveyCatid($v)
    {
        ...
        if ($this->survey_catid !== $v) {
            $this->survey_catid = $v;
            $this->modifiedColumns[SurveyCategoryTableMap::COL_SURVEY_CATID] = true;
        }
    ...
    /**
     * Set the value of [survey_cat_name] column.
     *
     * @param string|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setSurveyCatName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->survey_cat_name !== $v) {
            $this->survey_cat_name = $v;
            $this->modifiedColumns[SurveyCategoryTableMap::COL_SURVEY_CAT_NAME] = true;
        }
    ...
    public function setCompanyId($v)
    {
        ...
        if ($this->company_id !== $v) {
            $this->company_id = $v;
            $this->modifiedColumns[SurveyCategoryTableMap::COL_COMPANY_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SurveyCategoryTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SurveyCategoryTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[SurveyCategoryTableMap::COL_STATUS] = true;
        }
    ...
    public function setOrgunitid($v)
    {
        ...
        if ($this->orgunitid !== $v) {
            $this->orgunitid = $v;
            $this->modifiedColumns[SurveyCategoryTableMap::COL_ORGUNITID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SurveyCategoryTableMap::translateFieldName('SurveyCatid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->survey_catid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SurveyCategoryTableMap::translateFieldName('SurveyCatName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->survey_cat_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SurveyCategoryTableMap::translateFieldName('CompanyId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->company_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SurveyCategoryTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SurveyCategoryTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->updated_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SurveyCategoryTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SurveyCategoryTableMap::translateFieldName('Orgunitid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = SurveyCategoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\entities\\SurveyCategory'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildSurveyCategoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see SurveyCategory::setDeleted()
     * @see SurveyCategory::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSurveyCategoryQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SurveyCategoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[SurveyCategoryTableMap::COL_SURVEY_CATID] = true;
        if (null !== $this->survey_catid) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . SurveyCategoryTableMap::COL_SURVEY_CATID . ')');
        }
        if (null === $this->survey_catid) {
            try {
                $dataFetcher = $con->query("SELECT nextval('survey_category_survey_catid_seq')");
                $this->survey_catid = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(SurveyCategoryTableMap::COL_SURVEY_CATID)) {
            $modifiedColumns[':p' . $index++]  = 'survey_catid';
        }
        if ($this->isColumnModified(SurveyCategoryTableMap::COL_SURVEY_CAT_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'survey_cat_name';
        }
        if ($this->isColumnModified(SurveyCategoryTableMap::COL_COMPANY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'company_id';
        }
        if ($this->isColumnModified(SurveyCategoryTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(SurveyCategoryTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }
        if ($this->isColumnModified(SurveyCategoryTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(SurveyCategoryTableMap::COL_ORGUNITID)) {
            $modifiedColumns[':p' . $index++]  = 'orgunitid';
        }

        $sql = sprintf(
            'INSERT INTO survey_category (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'survey_catid':
                        ...
                        break;
                    case 'survey_cat_name':
                        $stmt->bindValue($identifier, $this->survey_cat_name, PDO::PARAM_STR);
    ...
    {
        $pos = SurveyCategoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SurveyCategory'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['SurveyCategory'][$this->hashCode()] = true;
        $keys = SurveyCategoryTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getSurveyCatid(),
            $keys[1] => $this->getSurveyCatName(),
            $keys[2] => $this->getCompanyId(),
            $keys[3] => $this->getCreatedAt(),
            $keys[4] => $this->getUpdatedAt(),
            $keys[5] => $this->getStatus(),
            $keys[6] => $this->getOrgunitid(),
        ];
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setSurveyCatid($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setSurveyCatName($arr[$keys[1]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SurveyCategoryTableMap::COL_SURVEY_CATID)) {
            $criteria->add(SurveyCategoryTableMap::COL_SURVEY_CATID, $this->survey_catid);
        }
        if ($this->isColumnModified(SurveyCategoryTableMap::COL_SURVEY_CAT_NAME)) {
            $criteria->add(SurveyCategoryTableMap::COL_SURVEY_CAT_NAME, $this->survey_cat_name);
        }
        if ($this->isColumnModified(SurveyCategoryTableMap::COL_COMPANY_ID)) {
            $criteria->add(SurveyCategoryTableMap::COL_COMPANY_ID, $this->company_id);
        }
        if ($this->isColumnModified(SurveyCategoryTableMap::COL_CREATED_AT)) {
            $criteria->add(SurveyCategoryTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(SurveyCategoryTableMap::COL_UPDATED_AT)) {
            $criteria->add(SurveyCategoryTableMap::COL_UPDATED_AT, $this->updated_at);
        }
        if ($this->isColumnModified(SurveyCategoryTableMap::COL_STATUS)) {
            $criteria->add(SurveyCategoryTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(SurveyCategoryTableMap::COL_ORGUNITID)) {
            $criteria->add(SurveyCategoryTableMap::COL_ORGUNITID, $this->orgunitid);
        }
    ...
    {
        $criteria = ChildSurveyCategoryQuery::create();
        $criteria->add(SurveyCategoryTableMap::COL_SURVEY_CATID, $this->survey_catid);
    ...
    {
        $validPk = null !== $this->getSurveyCatid();
    ...
    /**
     * Generic method to set the primary key (survey_catid column).
     *
    ...
    {
        return null === $this->getSurveyCatid();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \entities\SurveyCategory (or compatible) type.
    ...
    {
        $copyObj->setSurveyCatName($this->getSurveyCatName());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setSurveyCatid(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \entities\SurveyCategory Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getCompany(?ConnectionInterface $con = null)
    {
        if ($this->aCompany === null && ($this->company_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCompany->addSurveyCategories($this);
             */
        }
     ...
     * If this ChildSurveyCategory is new, it will return
    ...
    public function setSurveys(Collection $surveys, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($surveysToDelete as $surveyRemoved) {
            $surveyRemoved->setSurveyCategory(null);
        }
     ...
     * Otherwise if this SurveyCategory is new, it will return
     * an empty collection; or if this SurveyCategory has previously
     * been saved, it will retrieve related Surveys from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SurveyCategory.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
    ...
    {
        if (null !== $this->aCompany) {
            $this->aCompany->removeSurveyCategory($this);
        }
        $this->survey_catid = null;
        $this->survey_cat_name = null;
    ...
    {
        return (string) $this->exportTo(SurveyCategoryTableMap::DEFAULT_STRING_FORMAT);
    }
