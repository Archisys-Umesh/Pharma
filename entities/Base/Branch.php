...
abstract class Branch implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\entities\\Map\\BranchTableMap';
    ...
    /**
     * Initializes internal state of entities\Base\Branch object.
     * @see applyDefaults()
     */
    ...
    public function setBranchId($v)
    {
        ...
        if ($this->branch_id !== $v) {
            $this->branch_id = $v;
            $this->modifiedColumns[BranchTableMap::COL_BRANCH_ID] = true;
        }
    ...
    public function setCompanyId($v)
    {
        ...
        if ($this->company_id !== $v) {
            $this->company_id = $v;
            $this->modifiedColumns[BranchTableMap::COL_COMPANY_ID] = true;
        }
    ...
    public function setBranchcode($v)
    {
        ...
        if ($this->branchcode !== $v) {
            $this->branchcode = $v;
            $this->modifiedColumns[BranchTableMap::COL_BRANCHCODE] = true;
        }
    ...
    public function setBranchname($v)
    {
        ...
        if ($this->branchname !== $v) {
            $this->branchname = $v;
            $this->modifiedColumns[BranchTableMap::COL_BRANCHNAME] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[BranchTableMap::COL_STATUS] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[BranchTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[BranchTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setIstateid($v)
    {
        ...
        if ($this->istateid !== $v) {
            $this->istateid = $v;
            $this->modifiedColumns[BranchTableMap::COL_ISTATEID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BranchTableMap::translateFieldName('BranchId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->branch_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BranchTableMap::translateFieldName('CompanyId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->company_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BranchTableMap::translateFieldName('Branchcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->branchcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BranchTableMap::translateFieldName('Branchname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->branchname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : BranchTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : BranchTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : BranchTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->updated_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : BranchTableMap::translateFieldName('Istateid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = BranchTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\entities\\Branch'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[BranchTableMap::COL_BRANCH_ID] = true;
        if (null !== $this->branch_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . BranchTableMap::COL_BRANCH_ID . ')');
        }
        if (null === $this->branch_id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('branch_branch_id_seq')");
                $this->branch_id = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(BranchTableMap::COL_BRANCH_ID)) {
            $modifiedColumns[':p' . $index++]  = 'branch_id';
        }
        if ($this->isColumnModified(BranchTableMap::COL_COMPANY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'company_id';
        }
        if ($this->isColumnModified(BranchTableMap::COL_BRANCHCODE)) {
            $modifiedColumns[':p' . $index++]  = 'branchcode';
        }
        if ($this->isColumnModified(BranchTableMap::COL_BRANCHNAME)) {
            $modifiedColumns[':p' . $index++]  = 'branchname';
        }
        if ($this->isColumnModified(BranchTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(BranchTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(BranchTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }
        if ($this->isColumnModified(BranchTableMap::COL_ISTATEID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'branchcode':
                        ...
                        break;
                    case 'branchname':
                        $stmt->bindValue($identifier, $this->branchname, PDO::PARAM_STR);
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            $keys[0] => $this->getBranchId(),
            $keys[1] => $this->getCompanyId(),
            $keys[2] => $this->getBranchcode(),
            $keys[3] => $this->getBranchname(),
            $keys[4] => $this->getStatus(),
            $keys[5] => $this->getCreatedAt(),
            $keys[6] => $this->getUpdatedAt(),
            $keys[7] => $this->getIstateid(),
        ];
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(BranchTableMap::COL_BRANCH_ID)) {
            $criteria->add(BranchTableMap::COL_BRANCH_ID, $this->branch_id);
        }
        if ($this->isColumnModified(BranchTableMap::COL_COMPANY_ID)) {
            $criteria->add(BranchTableMap::COL_COMPANY_ID, $this->company_id);
        }
        if ($this->isColumnModified(BranchTableMap::COL_BRANCHCODE)) {
            $criteria->add(BranchTableMap::COL_BRANCHCODE, $this->branchcode);
        }
        if ($this->isColumnModified(BranchTableMap::COL_BRANCHNAME)) {
            $criteria->add(BranchTableMap::COL_BRANCHNAME, $this->branchname);
        }
        if ($this->isColumnModified(BranchTableMap::COL_STATUS)) {
            $criteria->add(BranchTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(BranchTableMap::COL_CREATED_AT)) {
            $criteria->add(BranchTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(BranchTableMap::COL_UPDATED_AT)) {
            $criteria->add(BranchTableMap::COL_UPDATED_AT, $this->updated_at);
        }
        if ($this->isColumnModified(BranchTableMap::COL_ISTATEID)) {
            $criteria->add(BranchTableMap::COL_ISTATEID, $this->istateid);
        }
    ...
    /**
     * Generic method to set the primary key (branch_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of \entities\Branch (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setBranchId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \entities\Branch Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getGeoState(?ConnectionInterface $con = null)
    {
        if ($this->aGeoState === null && ($this->istateid != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGeoState->addBranches($this);
             */
        }
    ...
    public function getCompany(?ConnectionInterface $con = null)
    {
        if ($this->aCompany === null && ($this->company_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCompany->addBranches($this);
             */
        }
    ...
    public function setEmployees(Collection $employees, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($employeesToDelete as $employeeRemoved) {
            $employeeRemoved->setBranch(null);
        }
    ...
    {
        if (null !== $this->aGeoState) {
            $this->aGeoState->removeBranch($this);
        }
        if (null !== $this->aCompany) {
            $this->aCompany->removeBranch($this);
        }
        $this->branch_id = null;
