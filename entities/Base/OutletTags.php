...
/**
 * Base class that represents a row from the 'outlet_tags' table.
 *
 *
 *
 * @package    propel.generator.entities.Base
 */
abstract class OutletTags implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\entities\\Map\\OutletTagsTableMap';
    ...
    /**
     * The value for the outlet_tag_id field.
     *
     * @var        int
     */
    protected $outlet_tag_id;
    ...
    /**
     * Initializes internal state of entities\Base\OutletTags object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>OutletTags</code> instance.  If
     * <code>obj</code> is an instance of <code>OutletTags</code>, delegates to
     * <code>equals(OutletTags)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [outlet_tag_id] column value.
     *
     * @return int
     */
    public function getOutletTagId()
    {
        return $this->outlet_tag_id;
    }
    ...
    /**
     * Set the value of [outlet_tag_id] column.
     *
     * @param int $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setOutletTagId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->outlet_tag_id !== $v) {
            $this->outlet_tag_id = $v;
            $this->modifiedColumns[OutletTagsTableMap::COL_OUTLET_TAG_ID] = true;
        }
    ...
    public function setTagName($v)
    {
        ...
        if ($this->tag_name !== $v) {
            $this->tag_name = $v;
            $this->modifiedColumns[OutletTagsTableMap::COL_TAG_NAME] = true;
        }
    ...
    public function setCompanyId($v)
    {
        ...
        if ($this->company_id !== $v) {
            $this->company_id = $v;
            $this->modifiedColumns[OutletTagsTableMap::COL_COMPANY_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OutletTagsTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OutletTagsTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setIntegrationId($v)
    {
        ...
        if ($this->integration_id !== $v) {
            ...
            $this->modifiedColumns[OutletTagsTableMap::COL_INTEGRATION_ID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OutletTagsTableMap::translateFieldName('OutletTagId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->outlet_tag_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OutletTagsTableMap::translateFieldName('TagName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tag_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OutletTagsTableMap::translateFieldName('CompanyId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->company_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OutletTagsTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OutletTagsTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->updated_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : OutletTagsTableMap::translateFieldName('IntegrationId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = OutletTagsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\entities\\OutletTags'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildOutletTagsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see OutletTags::setDeleted()
     * @see OutletTags::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOutletTagsQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OutletTagsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[OutletTagsTableMap::COL_OUTLET_TAG_ID] = true;
        if (null !== $this->outlet_tag_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . OutletTagsTableMap::COL_OUTLET_TAG_ID . ')');
        }
        if (null === $this->outlet_tag_id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('outlet_tags_outlet_tag_id_seq')");
                $this->outlet_tag_id = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(OutletTagsTableMap::COL_OUTLET_TAG_ID)) {
            $modifiedColumns[':p' . $index++]  = 'outlet_tag_id';
        }
        if ($this->isColumnModified(OutletTagsTableMap::COL_TAG_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'tag_name';
        }
        if ($this->isColumnModified(OutletTagsTableMap::COL_COMPANY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'company_id';
        }
        if ($this->isColumnModified(OutletTagsTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(OutletTagsTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }
        if ($this->isColumnModified(OutletTagsTableMap::COL_INTEGRATION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'integration_id';
        }

        $sql = sprintf(
            'INSERT INTO outlet_tags (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'outlet_tag_id':
                        $stmt->bindValue($identifier, $this->outlet_tag_id, PDO::PARAM_INT);
    ...
    {
        $pos = OutletTagsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OutletTags'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['OutletTags'][$this->hashCode()] = true;
        $keys = OutletTagsTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getOutletTagId(),
            $keys[1] => $this->getTagName(),
            $keys[2] => $this->getCompanyId(),
            $keys[3] => $this->getCreatedAt(),
            $keys[4] => $this->getUpdatedAt(),
            $keys[5] => $this->getIntegrationId(),
        ];
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setOutletTagId($arr[$keys[0]]);
        }
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setIntegrationId($arr[$keys[5]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(OutletTagsTableMap::COL_OUTLET_TAG_ID)) {
            $criteria->add(OutletTagsTableMap::COL_OUTLET_TAG_ID, $this->outlet_tag_id);
        }
        if ($this->isColumnModified(OutletTagsTableMap::COL_TAG_NAME)) {
            $criteria->add(OutletTagsTableMap::COL_TAG_NAME, $this->tag_name);
        }
        if ($this->isColumnModified(OutletTagsTableMap::COL_COMPANY_ID)) {
            $criteria->add(OutletTagsTableMap::COL_COMPANY_ID, $this->company_id);
        }
        if ($this->isColumnModified(OutletTagsTableMap::COL_CREATED_AT)) {
            $criteria->add(OutletTagsTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(OutletTagsTableMap::COL_UPDATED_AT)) {
            $criteria->add(OutletTagsTableMap::COL_UPDATED_AT, $this->updated_at);
        }
        if ($this->isColumnModified(OutletTagsTableMap::COL_INTEGRATION_ID)) {
            $criteria->add(OutletTagsTableMap::COL_INTEGRATION_ID, $this->integration_id);
        }
    ...
    {
        $criteria = ChildOutletTagsQuery::create();
        $criteria->add(OutletTagsTableMap::COL_OUTLET_TAG_ID, $this->outlet_tag_id);
    ...
    {
        $validPk = null !== $this->getOutletTagId();
    ...
    /**
     * Generic method to set the primary key (outlet_tag_id column).
     *
    ...
    {
        return null === $this->getOutletTagId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \entities\OutletTags (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setOutletTagId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \entities\OutletTags Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getCompany(?ConnectionInterface $con = null)
    {
        if ($this->aCompany === null && ($this->company_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCompany->addOutletTagss($this);
             */
        }
     ...
     * If this ChildOutletTags is new, it will return
    ...
    public function setOnBoardRequestAddresses(Collection $onBoardRequestAddresses, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($onBoardRequestAddressesToDelete as $onBoardRequestAddressRemoved) {
            $onBoardRequestAddressRemoved->setOutletTags(null);
        }
    ...
    protected function doAddOnBoardRequestAddress(ChildOnBoardRequestAddress $onBoardRequestAddress): void
    {
        ...
        $onBoardRequestAddress->setOutletTags($this);
    }
    ...
    public function removeOnBoardRequestAddress(ChildOnBoardRequestAddress $onBoardRequestAddress)
    {
        if ($this->getOnBoardRequestAddresses()->contains($onBoardRequestAddress)) {
            ...
            $onBoardRequestAddress->setOutletTags(null);
        }
     ...
     * Otherwise if this OutletTags is new, it will return
     * an empty collection; or if this OutletTags has previously
     * been saved, it will retrieve related OnBoardRequestAddresses from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in OutletTags.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
    ...
    {
        if (null !== $this->aCompany) {
            $this->aCompany->removeOutletTags($this);
        }
        $this->outlet_tag_id = null;
        $this->tag_name = null;
    ...
    {
        return (string) $this->exportTo(OutletTagsTableMap::DEFAULT_STRING_FORMAT);
    }
