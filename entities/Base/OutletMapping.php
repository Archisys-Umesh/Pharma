...
/**
 * Base class that represents a row from the 'outlet_mapping' table.
 *
 *
 *
 * @package    propel.generator.entities.Base
 */
abstract class OutletMapping implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\entities\\Map\\OutletMappingTableMap';
    ...
    /**
     * Initializes internal state of entities\Base\OutletMapping object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>OutletMapping</code> instance.  If
     * <code>obj</code> is an instance of <code>OutletMapping</code>, delegates to
     * <code>equals(OutletMapping)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setMappingId($v)
    {
        ...
        if ($this->mapping_id !== $v) {
            $this->mapping_id = $v;
            $this->modifiedColumns[OutletMappingTableMap::COL_MAPPING_ID] = true;
        }
    ...
    public function setPrimaryOutletId($v)
    {
        ...
        if ($this->primary_outlet_id !== $v) {
            ...
            $this->modifiedColumns[OutletMappingTableMap::COL_PRIMARY_OUTLET_ID] = true;
        }
    ...
    public function setSecondaryOutletId($v)
    {
        ...
        if ($this->secondary_outlet_id !== $v) {
            ...
            $this->modifiedColumns[OutletMappingTableMap::COL_SECONDARY_OUTLET_ID] = true;
        }
    ...
    public function setPricebookId($v)
    {
        ...
        if ($this->pricebook_id !== $v) {
            $this->pricebook_id = $v;
            $this->modifiedColumns[OutletMappingTableMap::COL_PRICEBOOK_ID] = true;
        }
    ...
    public function setIsdefault($v)
    {
        ...
        if ($this->isdefault !== $v) {
            $this->isdefault = $v;
            $this->modifiedColumns[OutletMappingTableMap::COL_ISDEFAULT] = true;
        }
    ...
    public function setCategoryType($v)
    {
        ...
        if ($this->category_type !== $v) {
            ...
            $this->modifiedColumns[OutletMappingTableMap::COL_CATEGORY_TYPE] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OutletMappingTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OutletMappingTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OutletMappingTableMap::translateFieldName('MappingId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mapping_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OutletMappingTableMap::translateFieldName('PrimaryOutletId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->primary_outlet_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OutletMappingTableMap::translateFieldName('SecondaryOutletId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->secondary_outlet_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OutletMappingTableMap::translateFieldName('PricebookId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pricebook_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OutletMappingTableMap::translateFieldName('Isdefault', TableMap::TYPE_PHPNAME, $indexType)];
            $this->isdefault = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : OutletMappingTableMap::translateFieldName('CategoryType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->category_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : OutletMappingTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : OutletMappingTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = OutletMappingTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\entities\\OutletMapping'), 0, $e);
        }
    }
    ...
    {
        if ($this->aOutlets !== null && $this->primary_outlet_id !== $this->aOutlets->getId()) {
            $this->aOutlets = null;
        }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildOutletMappingQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see OutletMapping::setDeleted()
     * @see OutletMapping::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOutletMappingQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OutletMappingTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if (null === $this->mapping_id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('outlet_mapping_mapping_id_seq')");
                $this->mapping_id = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(OutletMappingTableMap::COL_MAPPING_ID)) {
            $modifiedColumns[':p' . $index++]  = 'mapping_id';
        }
        if ($this->isColumnModified(OutletMappingTableMap::COL_PRIMARY_OUTLET_ID)) {
            $modifiedColumns[':p' . $index++]  = 'primary_outlet_id';
        }
        if ($this->isColumnModified(OutletMappingTableMap::COL_SECONDARY_OUTLET_ID)) {
            $modifiedColumns[':p' . $index++]  = 'secondary_outlet_id';
        }
        if ($this->isColumnModified(OutletMappingTableMap::COL_PRICEBOOK_ID)) {
            $modifiedColumns[':p' . $index++]  = 'pricebook_id';
        }
        if ($this->isColumnModified(OutletMappingTableMap::COL_ISDEFAULT)) {
            $modifiedColumns[':p' . $index++]  = 'isdefault';
        }
        if ($this->isColumnModified(OutletMappingTableMap::COL_CATEGORY_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'category_type';
        }
        if ($this->isColumnModified(OutletMappingTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(OutletMappingTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }

        $sql = sprintf(
            'INSERT INTO outlet_mapping (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'pricebook_id':
                        ...
                        break;
                    case 'isdefault':
                        $stmt->bindValue($identifier, $this->isdefault, PDO::PARAM_INT);
    ...
    {
        $pos = OutletMappingTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OutletMapping'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['OutletMapping'][$this->hashCode()] = true;
        $keys = OutletMappingTableMap::getFieldNames($keyType);
        $result = [
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setMappingId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setPrimaryOutletId($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setSecondaryOutletId($arr[$keys[2]]);
        }
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setCategoryType($arr[$keys[5]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(OutletMappingTableMap::COL_MAPPING_ID)) {
            $criteria->add(OutletMappingTableMap::COL_MAPPING_ID, $this->mapping_id);
        }
        if ($this->isColumnModified(OutletMappingTableMap::COL_PRIMARY_OUTLET_ID)) {
            $criteria->add(OutletMappingTableMap::COL_PRIMARY_OUTLET_ID, $this->primary_outlet_id);
        }
        if ($this->isColumnModified(OutletMappingTableMap::COL_SECONDARY_OUTLET_ID)) {
            $criteria->add(OutletMappingTableMap::COL_SECONDARY_OUTLET_ID, $this->secondary_outlet_id);
        }
        if ($this->isColumnModified(OutletMappingTableMap::COL_PRICEBOOK_ID)) {
            $criteria->add(OutletMappingTableMap::COL_PRICEBOOK_ID, $this->pricebook_id);
        }
        if ($this->isColumnModified(OutletMappingTableMap::COL_ISDEFAULT)) {
            $criteria->add(OutletMappingTableMap::COL_ISDEFAULT, $this->isdefault);
        }
        if ($this->isColumnModified(OutletMappingTableMap::COL_CATEGORY_TYPE)) {
            $criteria->add(OutletMappingTableMap::COL_CATEGORY_TYPE, $this->category_type);
        }
        if ($this->isColumnModified(OutletMappingTableMap::COL_CREATED_AT)) {
            $criteria->add(OutletMappingTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(OutletMappingTableMap::COL_UPDATED_AT)) {
            $criteria->add(OutletMappingTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildOutletMappingQuery::create();
        $criteria->add(OutletMappingTableMap::COL_MAPPING_ID, $this->mapping_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \entities\OutletMapping (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \entities\OutletMapping Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if ($v === null) {
            $this->setPrimaryOutletId(NULL);
        } else {
            $this->setPrimaryOutletId($v->getId());
        }
    ...
    {
        if ($this->aOutlets === null && ($this->primary_outlet_id != 0)) {
            $this->aOutlets = ChildOutletsQuery::create()->findPk($this->primary_outlet_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOutlets->addOutletMappings($this);
             */
        }
    ...
    public function getPricebooks(?ConnectionInterface $con = null)
    {
        if ($this->aPricebooks === null && ($this->pricebook_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPricebooks->addOutletMappings($this);
             */
        }
    ...
    {
        if (null !== $this->aOutlets) {
            $this->aOutlets->removeOutletMapping($this);
        }
        if (null !== $this->aPricebooks) {
            $this->aPricebooks->removeOutletMapping($this);
        }
    ...
    {
        return (string) $this->exportTo(OutletMappingTableMap::DEFAULT_STRING_FORMAT);
    }
