...
/**
 * Base class that represents a row from the 'grade_policy' table.
 *
 *
 *
 * @package    propel.generator.entities.Base
 */
abstract class GradePolicy implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\entities\\Map\\GradePolicyTableMap';
    ...
    /**
     * Initializes internal state of entities\Base\GradePolicy object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>GradePolicy</code> instance.  If
     * <code>obj</code> is an instance of <code>GradePolicy</code>, delegates to
     * <code>equals(GradePolicy)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Set the value of [gp_id] column.
     *
     * @param int $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setGpId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->gp_id !== $v) {
            $this->gp_id = $v;
            $this->modifiedColumns[GradePolicyTableMap::COL_GP_ID] = true;
        }
    ...
    public function setGradeid($v)
    {
        ...
        if ($this->gradeid !== $v) {
            $this->gradeid = $v;
            $this->modifiedColumns[GradePolicyTableMap::COL_GRADEID] = true;
        }
    ...
    public function setPolicyId($v)
    {
        ...
        if ($this->policy_id !== $v) {
            $this->policy_id = $v;
            $this->modifiedColumns[GradePolicyTableMap::COL_POLICY_ID] = true;
        }
    ...
    public function setEndDate($v)
    {
        ...
        if ($this->end_date !== null || $dt !== null) {
            if ($this->end_date === null || $dt === null || $dt->format("Y-m-d") !== $this->end_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[GradePolicyTableMap::COL_END_DATE] = true;
            }
    ...
    public function setStartDate($v)
    {
        ...
        if ($this->start_date !== null || $dt !== null) {
            if ($this->start_date === null || $dt === null || $dt->format("Y-m-d") !== $this->start_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[GradePolicyTableMap::COL_START_DATE] = true;
            }
        } // if either are not null
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GradePolicyTableMap::translateFieldName('GpId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gp_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GradePolicyTableMap::translateFieldName('Gradeid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gradeid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : GradePolicyTableMap::translateFieldName('PolicyId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->policy_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : GradePolicyTableMap::translateFieldName('EndDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->end_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : GradePolicyTableMap::translateFieldName('StartDate', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = GradePolicyTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\entities\\GradePolicy'), 0, $e);
        }
    }
    ...
    {
        if ($this->aGradeMaster !== null && $this->gradeid !== $this->aGradeMaster->getGradeid()) {
            $this->aGradeMaster = null;
        }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildGradePolicyQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see GradePolicy::setDeleted()
     * @see GradePolicy::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildGradePolicyQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GradePolicyTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if (null === $this->gp_id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('grade_policy_gp_id_seq')");
                $this->gp_id = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(GradePolicyTableMap::COL_GP_ID)) {
            $modifiedColumns[':p' . $index++]  = 'gp_id';
        }
        if ($this->isColumnModified(GradePolicyTableMap::COL_GRADEID)) {
            $modifiedColumns[':p' . $index++]  = 'gradeid';
        }
        if ($this->isColumnModified(GradePolicyTableMap::COL_POLICY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'policy_id';
        }
        if ($this->isColumnModified(GradePolicyTableMap::COL_END_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'end_date';
        }
        if ($this->isColumnModified(GradePolicyTableMap::COL_START_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'start_date';
        }

        $sql = sprintf(
            'INSERT INTO grade_policy (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'gp_id':
                        $stmt->bindValue($identifier, $this->gp_id, PDO::PARAM_INT);
    ...
    {
        $pos = GradePolicyTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GradePolicy'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['GradePolicy'][$this->hashCode()] = true;
        $keys = GradePolicyTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getGpId(),
            $keys[1] => $this->getGradeid(),
            $keys[2] => $this->getPolicyId(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setGpId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setGradeid($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setPolicyId($arr[$keys[2]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(GradePolicyTableMap::COL_GP_ID)) {
            $criteria->add(GradePolicyTableMap::COL_GP_ID, $this->gp_id);
        }
        if ($this->isColumnModified(GradePolicyTableMap::COL_GRADEID)) {
            $criteria->add(GradePolicyTableMap::COL_GRADEID, $this->gradeid);
        }
        if ($this->isColumnModified(GradePolicyTableMap::COL_POLICY_ID)) {
            $criteria->add(GradePolicyTableMap::COL_POLICY_ID, $this->policy_id);
        }
        if ($this->isColumnModified(GradePolicyTableMap::COL_END_DATE)) {
            $criteria->add(GradePolicyTableMap::COL_END_DATE, $this->end_date);
        }
        if ($this->isColumnModified(GradePolicyTableMap::COL_START_DATE)) {
            $criteria->add(GradePolicyTableMap::COL_START_DATE, $this->start_date);
        }
    ...
    {
        $criteria = ChildGradePolicyQuery::create();
        $criteria->add(GradePolicyTableMap::COL_GP_ID, $this->gp_id);
    ...
    /**
     * Generic method to set the primary key (gp_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of \entities\GradePolicy (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setGpId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \entities\GradePolicy Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if ($this->aGradeMaster === null && ($this->gradeid != 0)) {
            $this->aGradeMaster = ChildGradeMasterQuery::create()->findPk($this->gradeid, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aGradeMaster->addGradePolicies($this);
             */
        }
    ...
    public function getPolicyMaster(?ConnectionInterface $con = null)
    {
        if ($this->aPolicyMaster === null && ($this->policy_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPolicyMaster->addGradePolicies($this);
             */
        }
    ...
    {
        if (null !== $this->aGradeMaster) {
            $this->aGradeMaster->removeGradePolicy($this);
        }
        if (null !== $this->aPolicyMaster) {
            $this->aPolicyMaster->removeGradePolicy($this);
        }
        $this->gp_id = null;
        $this->gradeid = null;
        $this->policy_id = null;
    ...
    {
        return (string) $this->exportTo(GradePolicyTableMap::DEFAULT_STRING_FORMAT);
    }
