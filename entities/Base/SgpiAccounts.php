...
/**
 * Base class that represents a row from the 'sgpi_accounts' table.
 *
 *
 *
 * @package    propel.generator.entities.Base
 */
abstract class SgpiAccounts implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\entities\\Map\\SgpiAccountsTableMap';
    ...
    /**
     * Initializes internal state of entities\Base\SgpiAccounts object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>SgpiAccounts</code> instance.  If
     * <code>obj</code> is an instance of <code>SgpiAccounts</code>, delegates to
     * <code>equals(SgpiAccounts)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setSgpiAccountId($v)
    {
        ...
        if ($this->sgpi_account_id !== $v) {
            ...
            $this->modifiedColumns[SgpiAccountsTableMap::COL_SGPI_ACCOUNT_ID] = true;
        }
    ...
    public function setAccountName($v)
    {
        ...
        if ($this->account_name !== $v) {
            $this->account_name = $v;
            $this->modifiedColumns[SgpiAccountsTableMap::COL_ACCOUNT_NAME] = true;
        }
    ...
    public function setCompanyId($v)
    {
        ...
        if ($this->company_id !== $v) {
            $this->company_id = $v;
            $this->modifiedColumns[SgpiAccountsTableMap::COL_COMPANY_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SgpiAccountsTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SgpiAccountsTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setEmployeeId($v)
    {
        ...
        if ($this->employee_id !== $v) {
            $this->employee_id = $v;
            $this->modifiedColumns[SgpiAccountsTableMap::COL_EMPLOYEE_ID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SgpiAccountsTableMap::translateFieldName('SgpiAccountId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sgpi_account_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SgpiAccountsTableMap::translateFieldName('AccountName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->account_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SgpiAccountsTableMap::translateFieldName('CompanyId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->company_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SgpiAccountsTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SgpiAccountsTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->updated_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SgpiAccountsTableMap::translateFieldName('EmployeeId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = SgpiAccountsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\entities\\SgpiAccounts'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildSgpiAccountsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see SgpiAccounts::setDeleted()
     * @see SgpiAccounts::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSgpiAccountsQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SgpiAccountsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[SgpiAccountsTableMap::COL_SGPI_ACCOUNT_ID] = true;
        if (null !== $this->sgpi_account_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . SgpiAccountsTableMap::COL_SGPI_ACCOUNT_ID . ')');
        }
        if (null === $this->sgpi_account_id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('sgpi_accounts_sgpi_account_id_seq')");
                $this->sgpi_account_id = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(SgpiAccountsTableMap::COL_SGPI_ACCOUNT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'sgpi_account_id';
        }
        if ($this->isColumnModified(SgpiAccountsTableMap::COL_ACCOUNT_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'account_name';
        }
        if ($this->isColumnModified(SgpiAccountsTableMap::COL_COMPANY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'company_id';
        }
        if ($this->isColumnModified(SgpiAccountsTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(SgpiAccountsTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }
        if ($this->isColumnModified(SgpiAccountsTableMap::COL_EMPLOYEE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'employee_id';
        }

        $sql = sprintf(
            'INSERT INTO sgpi_accounts (%s) VALUES (%s)',
    ...
    {
        $pos = SgpiAccountsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SgpiAccounts'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['SgpiAccounts'][$this->hashCode()] = true;
        $keys = SgpiAccountsTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getSgpiAccountId(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setSgpiAccountId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setAccountName($arr[$keys[1]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SgpiAccountsTableMap::COL_SGPI_ACCOUNT_ID)) {
            $criteria->add(SgpiAccountsTableMap::COL_SGPI_ACCOUNT_ID, $this->sgpi_account_id);
        }
        if ($this->isColumnModified(SgpiAccountsTableMap::COL_ACCOUNT_NAME)) {
            $criteria->add(SgpiAccountsTableMap::COL_ACCOUNT_NAME, $this->account_name);
        }
        if ($this->isColumnModified(SgpiAccountsTableMap::COL_COMPANY_ID)) {
            $criteria->add(SgpiAccountsTableMap::COL_COMPANY_ID, $this->company_id);
        }
        if ($this->isColumnModified(SgpiAccountsTableMap::COL_CREATED_AT)) {
            $criteria->add(SgpiAccountsTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(SgpiAccountsTableMap::COL_UPDATED_AT)) {
            $criteria->add(SgpiAccountsTableMap::COL_UPDATED_AT, $this->updated_at);
        }
        if ($this->isColumnModified(SgpiAccountsTableMap::COL_EMPLOYEE_ID)) {
            $criteria->add(SgpiAccountsTableMap::COL_EMPLOYEE_ID, $this->employee_id);
        }
    ...
    {
        $criteria = ChildSgpiAccountsQuery::create();
        $criteria->add(SgpiAccountsTableMap::COL_SGPI_ACCOUNT_ID, $this->sgpi_account_id);
    ...
    {
        $validPk = null !== $this->getSgpiAccountId();
    ...
    /**
     * Generic method to set the primary key (sgpi_account_id column).
     *
    ...
    {
        return null === $this->getSgpiAccountId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \entities\SgpiAccounts (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setSgpiAccountId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \entities\SgpiAccounts Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getCompany(?ConnectionInterface $con = null)
    {
        if ($this->aCompany === null && ($this->company_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCompany->addSgpiAccountss($this);
             */
        }
     ...
     * If this ChildSgpiAccounts is new, it will return
    ...
    public function setSgpiTranss(Collection $sgpiTranss, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($sgpiTranssToDelete as $sgpiTransRemoved) {
            $sgpiTransRemoved->setSgpiAccounts(null);
        }
    ...
    protected function doAddSgpiTrans(ChildSgpiTrans $sgpiTrans): void
    {
        ...
        $sgpiTrans->setSgpiAccounts($this);
    }
    ...
    public function removeSgpiTrans(ChildSgpiTrans $sgpiTrans)
    {
        if ($this->getSgpiTranss()->contains($sgpiTrans)) {
            ...
            $sgpiTrans->setSgpiAccounts(null);
        }
     ...
     * Otherwise if this SgpiAccounts is new, it will return
     * an empty collection; or if this SgpiAccounts has previously
     * been saved, it will retrieve related SgpiTranss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SgpiAccounts.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
    ...
    {
        if (null !== $this->aCompany) {
            $this->aCompany->removeSgpiAccounts($this);
        }
    ...
    {
        return (string) $this->exportTo(SgpiAccountsTableMap::DEFAULT_STRING_FORMAT);
    }
