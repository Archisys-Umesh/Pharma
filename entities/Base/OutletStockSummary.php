...
/**
 * Base class that represents a row from the 'outlet_stock_summary' table.
 *
 *
 *
 * @package    propel.generator.entities.Base
 */
abstract class OutletStockSummary implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\entities\\Map\\OutletStockSummaryTableMap';
    ...
    /**
     * The value for the outlet_stock_summary_id field.
     *
     * @var        int
     */
    protected $outlet_stock_summary_id;
    ...
    /**
     * The value for the computed_closing_qty field.
     *
     * @var        int
     */
    protected $computed_closing_qty;
    ...
    /**
     * Initializes internal state of entities\Base\OutletStockSummary object.
     */
    ...
    /**
     * Compares this with another <code>OutletStockSummary</code> instance.  If
     * <code>obj</code> is an instance of <code>OutletStockSummary</code>, delegates to
     * <code>equals(OutletStockSummary)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [outlet_stock_summary_id] column value.
     *
     * @return int
     */
    public function getOutletStockSummaryId()
    {
        return $this->outlet_stock_summary_id;
    }
    ...
    /**
     * Get the [computed_closing_qty] column value.
     *
     * @return int
     */
    public function getComputedClosingQty()
    {
        return $this->computed_closing_qty;
    }
    ...
    /**
     * Set the value of [outlet_stock_summary_id] column.
     *
     * @param int $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setOutletStockSummaryId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->outlet_stock_summary_id !== $v) {
            $this->outlet_stock_summary_id = $v;
            $this->modifiedColumns[OutletStockSummaryTableMap::COL_OUTLET_STOCK_SUMMARY_ID] = true;
        }
    ...
    public function setOutletOrgId($v)
    {
        ...
        if ($this->outlet_org_id !== $v) {
            ...
            $this->modifiedColumns[OutletStockSummaryTableMap::COL_OUTLET_ORG_ID] = true;
        }
    ...
    public function setOutletId($v)
    {
        ...
        if ($this->outlet_id !== $v) {
            $this->outlet_id = $v;
            $this->modifiedColumns[OutletStockSummaryTableMap::COL_OUTLET_ID] = true;
        }
    ...
    public function setMoye($v)
    {
        ...
        if ($this->moye !== $v) {
            $this->moye = $v;
            $this->modifiedColumns[OutletStockSummaryTableMap::COL_MOYE] = true;
        }
    ...
    public function setBrandId($v)
    {
        ...
        if ($this->brand_id !== $v) {
            $this->brand_id = $v;
            $this->modifiedColumns[OutletStockSummaryTableMap::COL_BRAND_ID] = true;
        }
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[OutletStockSummaryTableMap::COL_PRODUCT_ID] = true;
        }
    ...
    public function setClosingQty($v)
    {
        ...
        if ($this->closing_qty !== $v) {
            $this->closing_qty = $v;
            $this->modifiedColumns[OutletStockSummaryTableMap::COL_CLOSING_QTY] = true;
        }
    ...
    /**
     * Set the value of [computed_closing_qty] column.
     *
     * @param int $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setComputedClosingQty($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->computed_closing_qty !== $v) {
            $this->computed_closing_qty = $v;
            $this->modifiedColumns[OutletStockSummaryTableMap::COL_COMPUTED_CLOSING_QTY] = true;
        }
    ...
    public function setCompetitorId($v)
    {
        ...
        if ($this->competitor_id !== $v) {
            ...
            $this->modifiedColumns[OutletStockSummaryTableMap::COL_COMPETITOR_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OutletStockSummaryTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OutletStockSummaryTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setCompanyId($v)
    {
        ...
        if ($this->company_id !== $v) {
            $this->company_id = $v;
            $this->modifiedColumns[OutletStockSummaryTableMap::COL_COMPANY_ID] = true;
        }
    ...
    public function setOrgunitid($v)
    {
        ...
        if ($this->orgunitid !== $v) {
            $this->orgunitid = $v;
            $this->modifiedColumns[OutletStockSummaryTableMap::COL_ORGUNITID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OutletStockSummaryTableMap::translateFieldName('OutletStockSummaryId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->outlet_stock_summary_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OutletStockSummaryTableMap::translateFieldName('OutletOrgId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->outlet_org_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OutletStockSummaryTableMap::translateFieldName('OutletId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->outlet_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OutletStockSummaryTableMap::translateFieldName('Moye', TableMap::TYPE_PHPNAME, $indexType)];
            $this->moye = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OutletStockSummaryTableMap::translateFieldName('BrandId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->brand_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : OutletStockSummaryTableMap::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : OutletStockSummaryTableMap::translateFieldName('ClosingQty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->closing_qty = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : OutletStockSummaryTableMap::translateFieldName('ComputedClosingQty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->computed_closing_qty = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : OutletStockSummaryTableMap::translateFieldName('CompetitorId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->competitor_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : OutletStockSummaryTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : OutletStockSummaryTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->updated_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : OutletStockSummaryTableMap::translateFieldName('CompanyId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->company_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : OutletStockSummaryTableMap::translateFieldName('Orgunitid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 13; // 13 = OutletStockSummaryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\entities\\OutletStockSummary'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildOutletStockSummaryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see OutletStockSummary::setDeleted()
     * @see OutletStockSummary::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOutletStockSummaryQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OutletStockSummaryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[OutletStockSummaryTableMap::COL_OUTLET_STOCK_SUMMARY_ID] = true;
        if (null !== $this->outlet_stock_summary_id) {
        ...
        if (null === $this->outlet_stock_summary_id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('outlet_stock_summary_outlet_stock_summary_id_seq')");
                $this->outlet_stock_summary_id = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_OUTLET_STOCK_SUMMARY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'outlet_stock_summary_id';
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_OUTLET_ORG_ID)) {
            $modifiedColumns[':p' . $index++]  = 'outlet_org_id';
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_OUTLET_ID)) {
            $modifiedColumns[':p' . $index++]  = 'outlet_id';
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_MOYE)) {
            $modifiedColumns[':p' . $index++]  = 'moye';
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_BRAND_ID)) {
            $modifiedColumns[':p' . $index++]  = 'brand_id';
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'product_id';
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_CLOSING_QTY)) {
            $modifiedColumns[':p' . $index++]  = 'closing_qty';
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_COMPUTED_CLOSING_QTY)) {
            $modifiedColumns[':p' . $index++]  = 'computed_closing_qty';
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_COMPETITOR_ID)) {
            $modifiedColumns[':p' . $index++]  = 'competitor_id';
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_COMPANY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'company_id';
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_ORGUNITID)) {
            $modifiedColumns[':p' . $index++]  = 'orgunitid';
        }

        $sql = sprintf(
            'INSERT INTO outlet_stock_summary (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'outlet_stock_summary_id':
                        $stmt->bindValue($identifier, $this->outlet_stock_summary_id, PDO::PARAM_INT);
                    ...
                    case 'closing_qty':
                        ...
                        break;
                    case 'computed_closing_qty':
                        $stmt->bindValue($identifier, $this->computed_closing_qty, PDO::PARAM_INT);
    ...
    {
        $pos = OutletStockSummaryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            case 0:
                return $this->getOutletStockSummaryId();
            ...
            case 7:
                return $this->getComputedClosingQty();
    ...
    {
        if (isset($alreadyDumpedObjects['OutletStockSummary'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['OutletStockSummary'][$this->hashCode()] = true;
        $keys = OutletStockSummaryTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getOutletStockSummaryId(),
            $keys[1] => $this->getOutletOrgId(),
            $keys[2] => $this->getOutletId(),
            $keys[3] => $this->getMoye(),
            $keys[4] => $this->getBrandId(),
            $keys[5] => $this->getProductId(),
            $keys[6] => $this->getClosingQty(),
            $keys[7] => $this->getComputedClosingQty(),
            $keys[8] => $this->getCompetitorId(),
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setOutletStockSummaryId($value);
                break;
            case 1:
            ...
            case 6:
                ...
                break;
            case 7:
                $this->setComputedClosingQty($value);
                break;
            case 8:
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setOutletStockSummaryId($arr[$keys[0]]);
        }
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setClosingQty($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setComputedClosingQty($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setCompetitorId($arr[$keys[8]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_OUTLET_STOCK_SUMMARY_ID)) {
            $criteria->add(OutletStockSummaryTableMap::COL_OUTLET_STOCK_SUMMARY_ID, $this->outlet_stock_summary_id);
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_OUTLET_ORG_ID)) {
            $criteria->add(OutletStockSummaryTableMap::COL_OUTLET_ORG_ID, $this->outlet_org_id);
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_OUTLET_ID)) {
            $criteria->add(OutletStockSummaryTableMap::COL_OUTLET_ID, $this->outlet_id);
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_MOYE)) {
            $criteria->add(OutletStockSummaryTableMap::COL_MOYE, $this->moye);
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_BRAND_ID)) {
            $criteria->add(OutletStockSummaryTableMap::COL_BRAND_ID, $this->brand_id);
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_PRODUCT_ID)) {
            $criteria->add(OutletStockSummaryTableMap::COL_PRODUCT_ID, $this->product_id);
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_CLOSING_QTY)) {
            $criteria->add(OutletStockSummaryTableMap::COL_CLOSING_QTY, $this->closing_qty);
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_COMPUTED_CLOSING_QTY)) {
            $criteria->add(OutletStockSummaryTableMap::COL_COMPUTED_CLOSING_QTY, $this->computed_closing_qty);
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_COMPETITOR_ID)) {
            $criteria->add(OutletStockSummaryTableMap::COL_COMPETITOR_ID, $this->competitor_id);
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_CREATED_AT)) {
            $criteria->add(OutletStockSummaryTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_UPDATED_AT)) {
            $criteria->add(OutletStockSummaryTableMap::COL_UPDATED_AT, $this->updated_at);
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_COMPANY_ID)) {
            $criteria->add(OutletStockSummaryTableMap::COL_COMPANY_ID, $this->company_id);
        }
        if ($this->isColumnModified(OutletStockSummaryTableMap::COL_ORGUNITID)) {
            $criteria->add(OutletStockSummaryTableMap::COL_ORGUNITID, $this->orgunitid);
        }
    ...
    {
        $criteria = ChildOutletStockSummaryQuery::create();
        $criteria->add(OutletStockSummaryTableMap::COL_OUTLET_STOCK_SUMMARY_ID, $this->outlet_stock_summary_id);
    ...
    {
        $validPk = null !== $this->getOutletStockSummaryId();
    ...
    /**
     * Generic method to set the primary key (outlet_stock_summary_id column).
     *
    ...
    {
        $this->setOutletStockSummaryId($key);
    }
    ...
    {
        return null === $this->getOutletStockSummaryId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \entities\OutletStockSummary (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setComputedClosingQty($this->getComputedClosingQty());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setOutletStockSummaryId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \entities\OutletStockSummary Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getBrands(?ConnectionInterface $con = null)
    {
        if ($this->aBrands === null && ($this->brand_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBrands->addOutletStockSummaries($this);
             */
        }
    ...
    public function getCompany(?ConnectionInterface $con = null)
    {
        if ($this->aCompany === null && ($this->company_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCompany->addOutletStockSummaries($this);
             */
        }
    ...
    public function getOrgUnit(?ConnectionInterface $con = null)
    {
        if ($this->aOrgUnit === null && ($this->orgunitid != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOrgUnit->addOutletStockSummaries($this);
             */
        }
    ...
    public function getOutlets(?ConnectionInterface $con = null)
    {
        if ($this->aOutlets === null && ($this->outlet_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOutlets->addOutletStockSummaries($this);
             */
        }
    ...
    public function getOutletOrgData(?ConnectionInterface $con = null)
    {
        if ($this->aOutletOrgData === null && ($this->outlet_org_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOutletOrgData->addOutletStockSummaries($this);
             */
        }
    ...
    public function getProducts(?ConnectionInterface $con = null)
    {
        if ($this->aProducts === null && ($this->product_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProducts->addOutletStockSummaries($this);
             */
        }
    ...
    {
        if (null !== $this->aBrands) {
            $this->aBrands->removeOutletStockSummary($this);
        }
        if (null !== $this->aCompany) {
            $this->aCompany->removeOutletStockSummary($this);
        }
        if (null !== $this->aOrgUnit) {
            $this->aOrgUnit->removeOutletStockSummary($this);
        }
        if (null !== $this->aOutlets) {
            $this->aOutlets->removeOutletStockSummary($this);
        }
        if (null !== $this->aOutletOrgData) {
            $this->aOutletOrgData->removeOutletStockSummary($this);
        }
        if (null !== $this->aProducts) {
            $this->aProducts->removeOutletStockSummary($this);
        }
        $this->outlet_stock_summary_id = null;
        ...
        $this->computed_closing_qty = null;
    ...
    {
        return (string) $this->exportTo(OutletStockSummaryTableMap::DEFAULT_STRING_FORMAT);
    }
