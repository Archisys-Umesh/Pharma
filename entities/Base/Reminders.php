...
/**
 * Base class that represents a row from the 'reminders' table.
 *
 *
 *
 * @package    propel.generator.entities.Base
 */
abstract class Reminders implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\entities\\Map\\RemindersTableMap';
    ...
    /**
     * The value for the reminder_id field.
     *
     * @var        int
     */
    ...
    /**
     * The value for the reminder_note field.
     *
     * Note: this column has a database default value of: ''
     * @var        string
     */
    protected $reminder_note;
    ...
    {
        $this->employee_id = 0;
        $this->outlet_org_id = 0;
        $this->reminder_note = '';
    }

    /**
     * Initializes internal state of entities\Base\Reminders object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Reminders</code> instance.  If
     * <code>obj</code> is an instance of <code>Reminders</code>, delegates to
     * <code>equals(Reminders)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [reminder_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [reminder_note] column value.
     *
     * @return string
     */
    public function getReminderNote()
    {
        return $this->reminder_note;
    }
    ...
    /**
     * Set the value of [reminder_id] column.
     *
     * @param int $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setReminderId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->reminder_id !== $v) {
            $this->reminder_id = $v;
            $this->modifiedColumns[RemindersTableMap::COL_REMINDER_ID] = true;
        }
    ...
    public function setEmployeeId($v)
    {
        ...
        if ($this->employee_id !== $v) {
            $this->employee_id = $v;
            $this->modifiedColumns[RemindersTableMap::COL_EMPLOYEE_ID] = true;
        }
    ...
    public function setOutletOrgId($v)
    {
        ...
        if ($this->outlet_org_id !== $v) {
            ...
            $this->modifiedColumns[RemindersTableMap::COL_OUTLET_ORG_ID] = true;
        }
    ...
    public function setReminderType($v)
    {
        ...
        if ($this->reminder_type !== $v) {
            ...
            $this->modifiedColumns[RemindersTableMap::COL_REMINDER_TYPE] = true;
        }
    ...
    public function setReminderDate($v)
    {
        ...
        if ($this->reminder_date !== null || $dt !== null) {
            if ($this->reminder_date === null || $dt === null || $dt->format("Y-m-d") !== $this->reminder_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[RemindersTableMap::COL_REMINDER_DATE] = true;
            }
    ...
    /**
     * Set the value of [reminder_note] column.
     *
     * @param string $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setReminderNote($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->reminder_note !== $v) {
            $this->reminder_note = $v;
            $this->modifiedColumns[RemindersTableMap::COL_REMINDER_NOTE] = true;
        }
    ...
    public function setCompanyId($v)
    {
        ...
        if ($this->company_id !== $v) {
            $this->company_id = $v;
            $this->modifiedColumns[RemindersTableMap::COL_COMPANY_ID] = true;
        }
    ...
    public function hasOnlyDefaultValues(): bool
    {
            ...
            if ($this->outlet_org_id !== 0) {
                return false;
            }

            if ($this->reminder_note !== '') {
                return false;
            }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RemindersTableMap::translateFieldName('ReminderId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->reminder_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RemindersTableMap::translateFieldName('EmployeeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->employee_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RemindersTableMap::translateFieldName('OutletOrgId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->outlet_org_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : RemindersTableMap::translateFieldName('ReminderType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->reminder_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : RemindersTableMap::translateFieldName('ReminderDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->reminder_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : RemindersTableMap::translateFieldName('ReminderNote', TableMap::TYPE_PHPNAME, $indexType)];
            $this->reminder_note = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : RemindersTableMap::translateFieldName('CompanyId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = RemindersTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\entities\\Reminders'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildRemindersQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see Reminders::setDeleted()
     * @see Reminders::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildRemindersQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RemindersTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[RemindersTableMap::COL_REMINDER_ID] = true;
        if (null !== $this->reminder_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . RemindersTableMap::COL_REMINDER_ID . ')');
        }
        if (null === $this->reminder_id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('reminders_reminder_id_seq')");
                $this->reminder_id = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(RemindersTableMap::COL_REMINDER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'reminder_id';
        }
        if ($this->isColumnModified(RemindersTableMap::COL_EMPLOYEE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'employee_id';
        }
        if ($this->isColumnModified(RemindersTableMap::COL_OUTLET_ORG_ID)) {
            $modifiedColumns[':p' . $index++]  = 'outlet_org_id';
        }
        if ($this->isColumnModified(RemindersTableMap::COL_REMINDER_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'reminder_type';
        }
        if ($this->isColumnModified(RemindersTableMap::COL_REMINDER_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'reminder_date';
        }
        if ($this->isColumnModified(RemindersTableMap::COL_REMINDER_NOTE)) {
            $modifiedColumns[':p' . $index++]  = 'reminder_note';
        }
        if ($this->isColumnModified(RemindersTableMap::COL_COMPANY_ID)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'reminder_id':
                        $stmt->bindValue($identifier, $this->reminder_id, PDO::PARAM_INT);
                    ...
                    case 'reminder_date':
                        ...
                        break;
                    case 'reminder_note':
                        $stmt->bindValue($identifier, $this->reminder_note, PDO::PARAM_STR);
    ...
    {
        $pos = RemindersTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Reminders'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['Reminders'][$this->hashCode()] = true;
        $keys = RemindersTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getReminderId(),
            $keys[1] => $this->getEmployeeId(),
            $keys[2] => $this->getOutletOrgId(),
            $keys[3] => $this->getReminderType(),
            $keys[4] => $this->getReminderDate(),
            $keys[5] => $this->getReminderNote(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setReminderId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setEmployeeId($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setOutletOrgId($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setReminderType($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setReminderDate($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setReminderNote($arr[$keys[5]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(RemindersTableMap::COL_REMINDER_ID)) {
            $criteria->add(RemindersTableMap::COL_REMINDER_ID, $this->reminder_id);
        }
        if ($this->isColumnModified(RemindersTableMap::COL_EMPLOYEE_ID)) {
            $criteria->add(RemindersTableMap::COL_EMPLOYEE_ID, $this->employee_id);
        }
        if ($this->isColumnModified(RemindersTableMap::COL_OUTLET_ORG_ID)) {
            $criteria->add(RemindersTableMap::COL_OUTLET_ORG_ID, $this->outlet_org_id);
        }
        if ($this->isColumnModified(RemindersTableMap::COL_REMINDER_TYPE)) {
            $criteria->add(RemindersTableMap::COL_REMINDER_TYPE, $this->reminder_type);
        }
        if ($this->isColumnModified(RemindersTableMap::COL_REMINDER_DATE)) {
            $criteria->add(RemindersTableMap::COL_REMINDER_DATE, $this->reminder_date);
        }
        if ($this->isColumnModified(RemindersTableMap::COL_REMINDER_NOTE)) {
            $criteria->add(RemindersTableMap::COL_REMINDER_NOTE, $this->reminder_note);
        }
        if ($this->isColumnModified(RemindersTableMap::COL_COMPANY_ID)) {
            $criteria->add(RemindersTableMap::COL_COMPANY_ID, $this->company_id);
        }
    ...
    {
        $criteria = ChildRemindersQuery::create();
        $criteria->add(RemindersTableMap::COL_REMINDER_ID, $this->reminder_id);
    ...
    {
        $validPk = null !== $this->getReminderId();
    ...
    /**
     * Generic method to set the primary key (reminder_id column).
     *
    ...
    {
        return null === $this->getReminderId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \entities\Reminders (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setReminderNote($this->getReminderNote());
        $copyObj->setCompanyId($this->getCompanyId());
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setReminderId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \entities\Reminders Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getEmployee(?ConnectionInterface $con = null)
    {
        if ($this->aEmployee === null && ($this->employee_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEmployee->addReminderss($this);
             */
        }
    ...
    public function getCompany(?ConnectionInterface $con = null)
    {
        if ($this->aCompany === null && ($this->company_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCompany->addReminderss($this);
             */
        }
    ...
    public function getOutletOrgData(?ConnectionInterface $con = null)
    {
        if ($this->aOutletOrgData === null && ($this->outlet_org_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOutletOrgData->addReminderss($this);
             */
        }
    ...
    {
        if (null !== $this->aEmployee) {
            $this->aEmployee->removeReminders($this);
        }
        if (null !== $this->aCompany) {
            $this->aCompany->removeReminders($this);
        }
        if (null !== $this->aOutletOrgData) {
            $this->aOutletOrgData->removeReminders($this);
        }
    ...
    {
        return (string) $this->exportTo(RemindersTableMap::DEFAULT_STRING_FORMAT);
    }
