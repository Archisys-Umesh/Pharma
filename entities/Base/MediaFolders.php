...
/**
 * Base class that represents a row from the 'media_folders' table.
 *
 *
 *
 * @package    propel.generator.entities.Base
 */
abstract class MediaFolders implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\entities\\Map\\MediaFoldersTableMap';
    ...
    /**
     * Initializes internal state of entities\Base\MediaFolders object.
     */
    ...
    /**
     * Compares this with another <code>MediaFolders</code> instance.  If
     * <code>obj</code> is an instance of <code>MediaFolders</code>, delegates to
     * <code>equals(MediaFolders)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setFolderId($v)
    {
        ...
        if ($this->folder_id !== $v) {
            $this->folder_id = $v;
            $this->modifiedColumns[MediaFoldersTableMap::COL_FOLDER_ID] = true;
        }
    ...
    public function setFolderName($v)
    {
        ...
        if ($this->folder_name !== $v) {
            $this->folder_name = $v;
            $this->modifiedColumns[MediaFoldersTableMap::COL_FOLDER_NAME] = true;
        }
    ...
    public function setParentId($v)
    {
        ...
        if ($this->parent_id !== $v) {
            $this->parent_id = $v;
            $this->modifiedColumns[MediaFoldersTableMap::COL_PARENT_ID] = true;
        }
    ...
    public function setCompanyId($v)
    {
        ...
        if ($this->company_id !== $v) {
            $this->company_id = $v;
            $this->modifiedColumns[MediaFoldersTableMap::COL_COMPANY_ID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MediaFoldersTableMap::translateFieldName('FolderId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->folder_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MediaFoldersTableMap::translateFieldName('FolderName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->folder_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MediaFoldersTableMap::translateFieldName('ParentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->parent_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MediaFoldersTableMap::translateFieldName('CompanyId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = MediaFoldersTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\entities\\MediaFolders'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildMediaFoldersQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see MediaFolders::setDeleted()
     * @see MediaFolders::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMediaFoldersQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MediaFoldersTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if (null === $this->folder_id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('media_folders_folder_id_seq')");
        ...
        if ($this->isColumnModified(MediaFoldersTableMap::COL_FOLDER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'folder_id';
        }
        if ($this->isColumnModified(MediaFoldersTableMap::COL_FOLDER_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'folder_name';
        }
        if ($this->isColumnModified(MediaFoldersTableMap::COL_PARENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'parent_id';
        }
        if ($this->isColumnModified(MediaFoldersTableMap::COL_COMPANY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'company_id';
        }

        $sql = sprintf(
            'INSERT INTO media_folders (%s) VALUES (%s)',
    ...
    {
        $pos = MediaFoldersTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['MediaFolders'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['MediaFolders'][$this->hashCode()] = true;
        $keys = MediaFoldersTableMap::getFieldNames($keyType);
        $result = [
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(MediaFoldersTableMap::COL_FOLDER_ID)) {
            $criteria->add(MediaFoldersTableMap::COL_FOLDER_ID, $this->folder_id);
        }
        if ($this->isColumnModified(MediaFoldersTableMap::COL_FOLDER_NAME)) {
            $criteria->add(MediaFoldersTableMap::COL_FOLDER_NAME, $this->folder_name);
        }
        if ($this->isColumnModified(MediaFoldersTableMap::COL_PARENT_ID)) {
            $criteria->add(MediaFoldersTableMap::COL_PARENT_ID, $this->parent_id);
        }
        if ($this->isColumnModified(MediaFoldersTableMap::COL_COMPANY_ID)) {
            $criteria->add(MediaFoldersTableMap::COL_COMPANY_ID, $this->company_id);
        }
    ...
    {
        $criteria = ChildMediaFoldersQuery::create();
        $criteria->add(MediaFoldersTableMap::COL_FOLDER_ID, $this->folder_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \entities\MediaFolders (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \entities\MediaFolders Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getCompany(?ConnectionInterface $con = null)
    {
        if ($this->aCompany === null && ($this->company_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCompany->addMediaFolderss($this);
             */
        }
     ...
     * If this ChildMediaFolders is new, it will return
    ...
    public function setMediaFiless(Collection $mediaFiless, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($mediaFilessToDelete as $mediaFilesRemoved) {
            $mediaFilesRemoved->setMediaFolders(null);
        }
    ...
    protected function doAddMediaFiles(ChildMediaFiles $mediaFiles): void
    {
        ...
        $mediaFiles->setMediaFolders($this);
    }
    ...
    public function removeMediaFiles(ChildMediaFiles $mediaFiles)
    {
        if ($this->getMediaFiless()->contains($mediaFiles)) {
            ...
            $mediaFiles->setMediaFolders(null);
        }
     ...
     * Otherwise if this MediaFolders is new, it will return
     * an empty collection; or if this MediaFolders has previously
     * been saved, it will retrieve related MediaFiless from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in MediaFolders.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildMediaFiles}> List of ChildMediaFiles objects
     */
    public function getMediaFilessJoinCompany(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildMediaFilesQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aCompany) {
            $this->aCompany->removeMediaFolders($this);
        }
        $this->folder_id = null;
    ...
    {
        return (string) $this->exportTo(MediaFoldersTableMap::DEFAULT_STRING_FORMAT);
    }
