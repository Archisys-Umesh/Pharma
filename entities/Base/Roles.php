...
abstract class Roles implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\entities\\Map\\RolesTableMap';
    ...
    /**
     * The value for the role_private field.
     *
     * Note: this column has a database default value of: false
     * @var        boolean
     */
    protected $role_private;
    ...
    /**
     * The value for the role_permissions field.
     *
     * @var        string|null
     */
    ...
    {
        $this->role_private = false;
    }

    /**
     * Initializes internal state of entities\Base\Roles object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [role_private] column value.
     *
     * @return boolean
     */
    public function getRolePrivate()
    {
        return $this->role_private;
    }
    ...
    /**
     * Get the [role_permissions] column value.
     *
     * @return string|null
     */
    ...
    public function setRoleId($v)
    {
        ...
        if ($this->role_id !== $v) {
            $this->role_id = $v;
            $this->modifiedColumns[RolesTableMap::COL_ROLE_ID] = true;
        }
    ...
    public function setRoleName($v)
    {
        ...
        if ($this->role_name !== $v) {
            $this->role_name = $v;
            $this->modifiedColumns[RolesTableMap::COL_ROLE_NAME] = true;
        }
    ...
    /**
     * Sets the value of the [role_private] column.
     ...
     * @return $this The current object (for fluent API support)
     */
    public function setRolePrivate($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->role_private !== $v) {
            $this->role_private = $v;
            $this->modifiedColumns[RolesTableMap::COL_ROLE_PRIVATE] = true;
        }
    ...
    public function setRoleDesc($v)
    {
        ...
        if ($this->role_desc !== $v) {
            $this->role_desc = $v;
            $this->modifiedColumns[RolesTableMap::COL_ROLE_DESC] = true;
        }
    ...
    /**
     * Set the value of [role_permissions] column.
     *
     * @param string|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setRolePermissions($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->role_permissions !== $v) {
            $this->role_permissions = $v;
            $this->modifiedColumns[RolesTableMap::COL_ROLE_PERMISSIONS] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RolesTableMap::translateFieldName('RoleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->role_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RolesTableMap::translateFieldName('RoleName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->role_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RolesTableMap::translateFieldName('RolePrivate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->role_private = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : RolesTableMap::translateFieldName('RoleDesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->role_desc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : RolesTableMap::translateFieldName('RolePermissions', TableMap::TYPE_PHPNAME, $indexType)];
            $this->role_permissions = (null !== $col) ? (string) $col : null;
            ...
            return $startcol + 5; // 5 = RolesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\entities\\Roles'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if (null === $this->role_id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('roles_role_id_seq')");
                $this->role_id = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(RolesTableMap::COL_ROLE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'role_id';
        }
        if ($this->isColumnModified(RolesTableMap::COL_ROLE_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'role_name';
        }
        if ($this->isColumnModified(RolesTableMap::COL_ROLE_PRIVATE)) {
            $modifiedColumns[':p' . $index++]  = 'role_private';
        }
        if ($this->isColumnModified(RolesTableMap::COL_ROLE_DESC)) {
            $modifiedColumns[':p' . $index++]  = 'role_desc';
        }
        if ($this->isColumnModified(RolesTableMap::COL_ROLE_PERMISSIONS)) {
            $modifiedColumns[':p' . $index++]  = 'role_permissions';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'role_name':
                        ...
                        break;
                    case 'role_private':
                        $stmt->bindValue($identifier, $this->role_private, PDO::PARAM_BOOL);

                        break;
                    case 'role_desc':
                        $stmt->bindValue($identifier, $this->role_desc, PDO::PARAM_STR);

                        break;
                    case 'role_permissions':
                        $stmt->bindValue($identifier, $this->role_permissions, PDO::PARAM_STR);
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[2] => $this->getRolePrivate(),
            $keys[3] => $this->getRoleDesc(),
            $keys[4] => $this->getRolePermissions(),
        ];
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setRolePrivate($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setRoleDesc($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setRolePermissions($arr[$keys[4]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(RolesTableMap::COL_ROLE_ID)) {
            $criteria->add(RolesTableMap::COL_ROLE_ID, $this->role_id);
        }
        if ($this->isColumnModified(RolesTableMap::COL_ROLE_NAME)) {
            $criteria->add(RolesTableMap::COL_ROLE_NAME, $this->role_name);
        }
        if ($this->isColumnModified(RolesTableMap::COL_ROLE_PRIVATE)) {
            $criteria->add(RolesTableMap::COL_ROLE_PRIVATE, $this->role_private);
        }
        if ($this->isColumnModified(RolesTableMap::COL_ROLE_DESC)) {
            $criteria->add(RolesTableMap::COL_ROLE_DESC, $this->role_desc);
        }
        if ($this->isColumnModified(RolesTableMap::COL_ROLE_PERMISSIONS)) {
            $criteria->add(RolesTableMap::COL_ROLE_PERMISSIONS, $this->role_permissions);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \entities\Roles (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setRolePrivate($this->getRolePrivate());
        $copyObj->setRoleDesc($this->getRoleDesc());
        $copyObj->setRolePermissions($this->getRolePermissions());
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \entities\Roles Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
