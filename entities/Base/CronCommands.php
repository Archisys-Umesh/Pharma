...
/**
 * Base class that represents a row from the 'cron_commands' table.
 *
 *
 *
 * @package    propel.generator.entities.Base
 */
abstract class CronCommands implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\entities\\Map\\CronCommandsTableMap';
    ...
    /**
     * Initializes internal state of entities\Base\CronCommands object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CronCommands</code> instance.  If
     * <code>obj</code> is an instance of <code>CronCommands</code>, delegates to
     * <code>equals(CronCommands)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CronCommandsTableMap::COL_ID] = true;
        }
    ...
    public function setCommandKey($v)
    {
        ...
        if ($this->command_key !== $v) {
            $this->command_key = $v;
            $this->modifiedColumns[CronCommandsTableMap::COL_COMMAND_KEY] = true;
        }
    ...
    public function setScheduleTime($v)
    {
        ...
        if ($this->schedule_time !== null || $dt !== null) {
            if ($this->schedule_time === null || $dt === null || $dt->format("H:i:s.u") !== $this->schedule_time->format("H:i:s.u")) {
                ...
                $this->modifiedColumns[CronCommandsTableMap::COL_SCHEDULE_TIME] = true;
            }
    ...
    public function setIsActive($v)
    {
        ...
        if ($this->is_active !== $v) {
            $this->is_active = $v;
            $this->modifiedColumns[CronCommandsTableMap::COL_IS_ACTIVE] = true;
        }
    ...
    public function setCompanyId($v)
    {
        ...
        if ($this->company_id !== $v) {
            $this->company_id = $v;
            $this->modifiedColumns[CronCommandsTableMap::COL_COMPANY_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CronCommandsTableMap::COL_CREATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CronCommandsTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CronCommandsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CronCommandsTableMap::translateFieldName('CommandKey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->command_key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CronCommandsTableMap::translateFieldName('ScheduleTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->schedule_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CronCommandsTableMap::translateFieldName('IsActive', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_active = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CronCommandsTableMap::translateFieldName('CompanyId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->company_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CronCommandsTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CronCommandsTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = CronCommandsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\entities\\CronCommands'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildCronCommandsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see CronCommands::setDeleted()
     * @see CronCommands::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCronCommandsQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CronCommandsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('cron_commands_id_seq')");
        ...
        if ($this->isColumnModified(CronCommandsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(CronCommandsTableMap::COL_COMMAND_KEY)) {
            $modifiedColumns[':p' . $index++]  = 'command_key';
        }
        if ($this->isColumnModified(CronCommandsTableMap::COL_SCHEDULE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'schedule_time';
        }
        if ($this->isColumnModified(CronCommandsTableMap::COL_IS_ACTIVE)) {
            $modifiedColumns[':p' . $index++]  = 'is_active';
        }
        if ($this->isColumnModified(CronCommandsTableMap::COL_COMPANY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'company_id';
        }
        if ($this->isColumnModified(CronCommandsTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(CronCommandsTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }

        $sql = sprintf(
            'INSERT INTO cron_commands (%s) VALUES (%s)',
    ...
    {
        $pos = CronCommandsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CronCommands'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['CronCommands'][$this->hashCode()] = true;
        $keys = CronCommandsTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCommandKey(),
            $keys[2] => $this->getScheduleTime(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setCommandKey($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setScheduleTime($arr[$keys[2]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(CronCommandsTableMap::COL_ID)) {
            $criteria->add(CronCommandsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CronCommandsTableMap::COL_COMMAND_KEY)) {
            $criteria->add(CronCommandsTableMap::COL_COMMAND_KEY, $this->command_key);
        }
        if ($this->isColumnModified(CronCommandsTableMap::COL_SCHEDULE_TIME)) {
            $criteria->add(CronCommandsTableMap::COL_SCHEDULE_TIME, $this->schedule_time);
        }
        if ($this->isColumnModified(CronCommandsTableMap::COL_IS_ACTIVE)) {
            $criteria->add(CronCommandsTableMap::COL_IS_ACTIVE, $this->is_active);
        }
        if ($this->isColumnModified(CronCommandsTableMap::COL_COMPANY_ID)) {
            $criteria->add(CronCommandsTableMap::COL_COMPANY_ID, $this->company_id);
        }
        if ($this->isColumnModified(CronCommandsTableMap::COL_CREATED_AT)) {
            $criteria->add(CronCommandsTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(CronCommandsTableMap::COL_UPDATED_AT)) {
            $criteria->add(CronCommandsTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildCronCommandsQuery::create();
        $criteria->add(CronCommandsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \entities\CronCommands (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \entities\CronCommands Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getCompany(?ConnectionInterface $con = null)
    {
        if ($this->aCompany === null && ($this->company_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCompany->addCronCommandss($this);
             */
        }
     ...
     * If this ChildCronCommands is new, it will return
    ...
    public function setCronCommandLogss(Collection $cronCommandLogss, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($cronCommandLogssToDelete as $cronCommandLogsRemoved) {
            $cronCommandLogsRemoved->setCronCommands(null);
        }
    ...
    protected function doAddCronCommandLogs(ChildCronCommandLogs $cronCommandLogs): void
    {
        ...
        $cronCommandLogs->setCronCommands($this);
    }
    ...
    public function removeCronCommandLogs(ChildCronCommandLogs $cronCommandLogs)
    {
        if ($this->getCronCommandLogss()->contains($cronCommandLogs)) {
            ...
            $cronCommandLogs->setCronCommands(null);
        }
     ...
     * Otherwise if this CronCommands is new, it will return
     * an empty collection; or if this CronCommands has previously
     * been saved, it will retrieve related CronCommandLogss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CronCommands.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildCronCommandLogs}> List of ChildCronCommandLogs objects
     */
    public function getCronCommandLogssJoinCompany(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCronCommandLogsQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aCompany) {
            $this->aCompany->removeCronCommands($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(CronCommandsTableMap::DEFAULT_STRING_FORMAT);
    }
